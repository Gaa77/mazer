        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tooltip</h3>
                    <p class="text-subtitle text-muted">The tooltip, also known as infotip or hint, is a common graphical user interface element which shows additional information on element hover.</p>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" data-bs-toggle="tooltip" title="Some tooltip text!">you probably</a>
                            ...
                            <a href="#" data-bs-toggle="tooltip" title="Another tooltip text!">have a</a>
                            ...
                            <a href="#" data-bs-toggle="tooltip" title="Another here too!">whatever keytar</a>
